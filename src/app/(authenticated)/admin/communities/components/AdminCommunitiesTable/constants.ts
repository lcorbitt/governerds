export const COLUMN_NAME_HEADER = "Name";
export const COLUMN_SLUG_HEADER = "Slug";
export const COLUMN_EDIT_HEADER = "Edit";
export const COLUMN_HOME_HEADER = "Home";
export const COLUMN_INVITE_HEADER = "Invite";

export const EXPORT_NAME_HEADER = "Name";
...
export const COLUMN_EDIT_CLASS = "whitespace-nowrap";
export const COLUMN_INVITE_CLASS = "min-w-[16rem]";
export const INVITE_CELL_CLASS = "flex flex-col gap-2 sm:flex-row sm:items-end";
export const INVITE_FIELD_CLASS = "flex min-w-0 flex-1 flex-col gap-2";
